/* Copyright (c) UNC Chapel Hill University Library, created by Hugh A. Cayless and published 
 * under the Clear BSD licence.  See http://svn.openlayers.org/trunk/openlayers/license.txt 
...
OpenLayers.Layer.OpenURL = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    getURL: function (bounds) {  
        ...
        + "&svc.level="+z+"&svc.rotate=0&svc.region=" + this.tilePos.lat + "," + this.tilePos.lon + "," + this.imageSize.h +
        "," + this.imageSize.w;
        var url = this.url;
