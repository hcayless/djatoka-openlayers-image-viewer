...
OpenLayers.Layer.OpenURL = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    initialize: function(name, url, options) {
        ...
        while ((this.imgMetadata.width / Math.pow(2, l-1)) < 400 && (this.imgMetadata.height / Math.pow(2, l-1)) < 400) {
          l--;
        ...
        this.zoomOffset = this.imgMetadata.levels - this.resolutions.length;
        this.zoomOffset = this.zoomOffset < 0?0:this.zoomOffset;
    },    
